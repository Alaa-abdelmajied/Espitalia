  ...
  const makeValidWorkingDays = () => {
    ...
    for (var i = 0; i < workingDays.length; i++) {
      newWorkingDays.push({
        ...
        from:
          workingDays[i].from.getHours() +
          ':' +
          workingDays[i].from.getMinutes(),
      ...
      <View style={styles.container}>
        ...
        <View style={styles.appointmentsContainer}>
          <ScrollView
            ...
            {doctor._id
              ? doctor.workingDays.map((card, cardIndex) => {
                  return (
                    <Animated.View
        ...
        <View style={styles.reviewsArea}>
                ...
                <View
                  ...
                  <SelectDropdown
                    ...
                    onSelect={(selectedItem, index) => {
                      setDay(
                        selectedItem[0] + selectedItem[1] + selectedItem[2],
                      );
                    }}
          ...
          {doctor._id && doctor.reviews.length != 0 ? (
            doctor.reviews.map((reviewCard, cardIndex) => {
              return (
                <View
                  key={cardIndex.toString()}
                  style={{
                  ...
                  <View
                    ...
                    <View
                      ...
                      <Rating
                        ...
                        ratingCount={5}
                        imageSize={25}
                        startingValue={reviewCard.rating}
                        fractions={1}
                        readonly={true}
                        style={{
                          marginRight: 10,
        ...
        <View style={{alignItems: 'center', margin: 20}}>
          <TouchableOpacity
            ...
            <AntDesign style={styles.newDay} name="deleteuser" />
